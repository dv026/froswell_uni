...
import { ExportIcon, GeoIcon } from '../../customIcon/map';

import cssTools from '../../tools/tools.module.less';
import css from './commonTools.module.less';
    ...
    return (
        <Box>
            <div className={cls(css.map__tools, css.map__tools_zoom)}>
                ...
                <div className={cls(cssTools.toolsGroup, cssTools.toolsGroup_y)}>
                    <div className={cssTools.tool} data-tip={t(dict.map.export)} onClick={p.onExport}>
