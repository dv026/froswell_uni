...
import { DirectedStageEnum } from 'prediction/enums/directedStageEnum';
import { currentStepState } from 'prediction/store/currentStep';
...
export const PredictionCalculation = () => {
