...
export const WellList = () => {
    ...
    const onClickByScenarioHandler = (w: WellBrief) => {
        wellMutations.set(new WellBrief(w.oilFieldId, null, w.prodObjId, null, w.scenarioId));
        resetCompareType();
        resetRepairMode();
    };

    const onClickBySubScenarioHandler = (w: WellBrief) => {
    ...
    return (
        <WellRoster
            clicks={{
                ...
                scenario: onClickByScenarioHandler,
                subScenario: onClickBySubScenarioHandler
            }}
