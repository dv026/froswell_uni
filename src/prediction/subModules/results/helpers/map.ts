...
export const scaleMeasure = (type: GridMapEnum): string =>
    cond([
        [
            ...
            always(i18n.t(dict.common.units.m3DayPa))
        ],
        [x => includes(x, [GridMapEnum.Pressure]), always(i18n.t(dict.common.units.atm))],
        [x => includes(x, [GridMapEnum.VolumeWaterCut]), always(i18n.t(dict.common.units.units))],
        [
            x =>
                includes(x, [
            ...
            always(i18n.t(dict.common.units.m3Accumulated))
        ],
        [
