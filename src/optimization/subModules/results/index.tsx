...
import { ComparisonChart } from './components/heatmap/comparisonChart';
                    ...
                    <Suspense fallback={<Spinner show={true} />}>
                        ...
                        <HStack>
                            <DisplayModes
                                ...
                                value={displayMode}
                                modes={[
                                    DisplayModeEnum.Chart,
                                    DisplayModeEnum.Map,
                                    DisplayModeEnum.TabletNew,
                                    DisplayModeEnum.Heatmap
                                ]}
                            />
                        </HStack>
                        <ExportReport />
...
const renderContent = (type: DisplayModeEnum) =>
    cond([
        ...
        [equals(DisplayModeEnum.Heatmap), always(<ComparisonChart />)],
        [T, always(null)]
    ])(type);
