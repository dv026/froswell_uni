...
export const ModuleMap = () => {
    ...
    const changeWell = useCallback(
        ...
        [setSelectedWells, well.oilFieldId, well.prodObjId, well.scenarioId, well.subScenarioId, wellMutations]
    );
    ...
    return (
        <MapCanvas
            key={`optimization_map_${well.toString()}_${plastId}`}
            layers={[
                ...
                new FlowCanvasLayer(
                    // TODO: типизация
                    // eslint-disable-next-line @typescript-eslint/no-explicit-any
                    mapSettings.flowInterwells as unknown as any,
                    appearance.showFlowInterwells,
                    mapSettings.canvasSize
                ),
