...
import { DirectedStageEnum } from 'optimization/enums/directedStageEnum';
import { currentStepState } from 'optimization/store/currentStep';
...
export const OptimizationCalculation = () => {
