...
// import { optimizationWellList, wellListState as optimizationWellListState } from '../../optimization/store/wellList';
...
// import { predictionWellList, wellListState as predictionWellListState } from '../../prediction/store/wellList';
...
// import { proxyWellList, wellListState as proxyWellListState } from '../../proxy/store/wellList';
...
// import { initialInsimSettingsRefresher } from './initialSettings';
...
// export const insimStatusDispatcherState = atom<InsimStatusDispatcher | undefined>({
//     key: 'calculation__insimStatusDispatcherState',
//     default: null
// });

// // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
// export const InsimStatusDispatcher = () => {
...
//     const addTask = useRecoilCallback(({ snapshot, set }) => async (status: ComputationStatus) => {
//         if (isNil(status)) {
//             return;
//         }
...
//     const updateTask = useRecoilCallback(({ snapshot, reset, set }) => async (status: ComputationStatus) => {
//         if (isNil(status)) {
//             return;
//         }

//         if (isFinished(status)) {
//             let list = await Promise.all([proxyWellList(), predictionWellList(), optimizationWellList()]);

//             // обновление списков скважин
//             set(proxyWellListState, list[0]);
//             set(predictionWellListState, list[1]);
//             set(optimizationWellListState, list[2]);

//             reset(initialInsimSettingsRefresher);
...
//     const removeTask = useRecoilCallback(({ snapshot, reset, set }) => async (key: string) => {
//         const tasks = await snapshot.getPromise(taskStorageState);
...
// export type InsimStatusDispatcher = ReturnType<typeof InsimStatusDispatcher>;
