...
import { submoduleState } from 'proxy/store/submodule';
...
import { Breadcrumb } from '../efficiency/components/breadcrumb';
import { ModuleGtm } from '../efficiency/components/moduleGtm';
import { ModuleMapWrapper } from '../efficiency/components/moduleMapWrapper';
import { ModuleTabletWrapper } from '../efficiency/components/moduleTabletWrapper';
import { ActionLinks } from '../preparation/components/actionLinks';
import { ExportReport } from './../efficiency/components/exportReport';
import { Settings } from './../efficiency/components/settings';
import { ModuleTabletCanvasWrapper } from './components/moduleTabletCanvasWrapper';
import { WellList } from './components/wellList';

export const ProxyEfficiencyResults = () => {
