...
import { isNullOrEmpty, sortAsc } from '../../../common/helpers/ramda';
...
export const remove = (id: number, groups: WellGroup[]): WellGroup[] =>
    find(propEq<WellGroup>('id', id), groups).isCalcGroup ? removeCalcGroup(id, groups) : removeOrderGroup(id, groups);
